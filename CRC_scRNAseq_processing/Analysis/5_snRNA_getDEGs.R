...
##===============================================================================================================================================================================
## Normal vs Tumor in each cell type
...
for(i in 1:length(celltypes)){
  ...
  #markers <- FindMarkers(object = cur_seurat_obj, test.use = "MAST", ident.1='Tumor', ident.2='Normal', only.pos = FALSE, min.pct = 0.1, logfc.threshold = 0.1, assay='RNA')
  markers <- FindMarkers(object = cur_seurat_obj, test.use = "MAST", ident.1='Tumor', ident.2='Normal', only.pos = FALSE, min.pct = 0, logfc.threshold = 0, assay='RNA')
