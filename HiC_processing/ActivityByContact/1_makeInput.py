...
creBedFile='/home/ajl1213/Projects/Endothelial/data/ChIP/Mapping/Peakcall/H3K27ac.mergepeaks.bed'
...
def getCreListPerGene():
    ...
    runScript='intersectBed -a '+DIR+'/BedFiles/TSS.'+winSize[0]+'.bed -b '+DIR+'/BedFiles/cRE.bed -wa -wb > '+DIR+'/BedFiles/TSS.cRE.'+winSize[0]+'.Intersect.bed'
    print runScript
    os.system(runScript)

    allDict={}
    input1=open(DIR+'/BedFiles/TSS.cRE.'+winSize[0]+'.Intersect.bed','r')
    all_input1=input1.readlines()
    for line in all_input1:
	each=line.strip().split('\t')
	ensembleID=each[3]
    ...
    output1=open(DIR+'/CreListPerGene/CreListPerGene.txt','w')
