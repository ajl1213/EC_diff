...
inputDIR='/home/ajl1213/Projects/Endothelial/data/HiC/FitHiC/OUTPUT'
PeakFile='/home/ajl1213/Projects/Endothelial/data/ChIP/Mapping/Peakcall/H3K27ac.mergepeaks.bed'
#sampleList=['ME','EC12','EC48']
sampleList=['MergedEC']
newID='MergedEC'
resolution=[10000, '10kb']
qvalCut=[0.05, '1e-1']
#qvalCut=[0.01,'1e-2']
binFile='/home/ajl1213/Projects/Endothelial/data/HiC/CovNorm/Bin/allchr.'+resolution[1]+'.bin'
...
def countProInter():
    ...
    print 'Number of target gene: '+str(len(set(targetGeneList)))
    print 'Number of P-centered interactions: '+str(interCount)
